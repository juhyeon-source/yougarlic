...
@router.post("/create")
async def create_flyer(request: CreateRequest):
    try:
        ...
        img_base64_list = generate_image(english_prompt, request.store_name, request.slogan, request.main_item)
        return JSONResponse(content={"images_base64": img_base64_list})
